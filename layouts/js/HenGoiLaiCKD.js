...
function reloadTable(data) {
    ...
    $('#scroll-horizontal-datatable').DataTable({
        ...
        createdRow: function (row, data, dataIndex) {
            ...
            const button1 = $('<button style="margin-right: 10px" onclick="showPopup(this,\'obccos/GetListUser\')">Click Me</button>')

                .text('Chuyển OB');

            const button2 = $(
                `<button onclick="showPopup2(this, '${sdt}')">Click Me</button>`
            )
                .text('Gia hạn');
...
function formatDate(inputDate) {
    ...
    // Nếu định dạng là "DD/MM/YYYY HH:MM:SS"
    else if (dateTimeRegex.test(inputDate)) {
